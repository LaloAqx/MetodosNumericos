...
public class MetodoDeGaussJordan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Gauss Jordan"));
        ...
        jLabel6.setFont(new java.awt.Font("Segoe UI Semibold", 3, 48)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(153, 0, 153));
        jLabel6.setText("Gauss Jordan");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(140, 10, 640, 60);

        jTextFieldNumeroDeIncognitas.setForeground(new java.awt.Color(153, 0, 153));
        ...
        jTextFieldNumeroDeIncognitas.setBounds(250, 90, 80, 30);
        ...
        jScrollPane1.setBounds(10, 130, 540, 100);

        jButtoncargar_matriz1.setFont(new java.awt.Font("Consolas", 0, 13)); // NOI18N
        jButtoncargar_matriz1.setForeground(new java.awt.Color(153, 0, 153));
        ...
        jButtoncargar_matriz1.setBounds(50, 250, 190, 30);

        jPanel2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));

        area_de_texto.setEditable(false);
        area_de_texto.setColumns(20);
        area_de_texto.setForeground(new java.awt.Color(153, 0, 153));
        ...
        jButtoncargar_matriz2.setForeground(new java.awt.Color(153, 0, 153));
        ...
        jButtoncargar_matriz.setBounds(350, 90, 190, 30);
        jPanel1.add(jSeparator1);
        jSeparator1.setBounds(10, 70, 540, 10);
        ...
        jButton1.setBounds(340, 250, 100, 30);
